...
- React Native chat and rich task/artifact cards on iOS, Android, and web with AG-UI protocol.
...
- [ ] Rich Threads persistence/replay and cross-device acceptance with local PGlite storage.
